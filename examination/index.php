           ...
           <div class="">
             <div class="page-title">
               ...
               <div class="title_left">
                 <h3>Welcome in the  Examination Room</h3>
               </div>
                   ...
                   <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" action="" method="post">
                        ...
                        <div class="item form-group">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12">Current Physician</label>
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" name="physician" class="form-control col-md-7 col-xs-12" required>
                            <small>fullnames</small>
                          </div>
                        </div>
                        <div class="item form-group">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12">Current Patient</label>
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" name="patient" class="form-control col-md-7 col-xs-12" required>
                            <small>fullnames</small>
                          </div>
                        </div>
                        <div class="item form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" name="cardnumber" class="form-control col-md-7 col-xs-12" required>
                            <small>Card Number</small>
                          </div>
                        </div>
                        <hr>
                        <div class="item form-group">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12">Current Prescription</label>
                          <div class="col-md-6 ">
                            <textarea name="prescription" rows="8" cols="80" class="form-control col-md-7 col-xs-12" style="resize:none;"></textarea>
                            <small>Prescription</small>
                          </div>
                        </div><hr>
                        <div class="item form-group">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12">Surgical Procedures</label>
                          <div class="col-md-6 ">
                            <textarea name="surgicalprocedures" rows="8" cols="80" class="form-control col-md-7 col-xs-12" style="resize:none;"></textarea>
                            <small>surgical procedures</small>
                          </div>
                        </div><hr>
                        <div class="item form-group">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12">Major illness</label>
                          <div class="col-md-6 ">
                            <textarea name="illness" rows="8" cols="80" class="form-control col-md-7 col-xs-12" style="resize:none;"></textarea>
                            <small>List major and both minor illness</small>
                          </div>
                        </div><hr>
                        <div class="item form-group">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12">Vacination</label>
                          <div class="col-md-6 ">
                            <textarea name="vaccinations" rows="8" cols="80" class="form-control col-md-7 col-xs-12" style="resize:none;"></textarea>
                            <small>Add vaccinations here</small>
                          </div>
                        </div><hr>
                        <div class="form-group">
                          <div class="col-md-6 col-md-offset-3">
                            <input type="reset" class="btn btn-info" value="reset form">
                            <button type="submit" class="btn btn-success">Store Data</button>
